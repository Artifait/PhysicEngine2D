...
{
    Window::Window()
        : window_(sf::VideoMode(1920, 1080), "Phisic Simulation", sf::Style::Default, sf::ContextSettings(0, 0, 8)),
        view_(sf::View(sf::FloatRect(0 - sf::VideoMode::getDesktopMode().width / 2.f, 0 - sf::VideoMode::getDesktopMode().height / 2.f, sf::VideoMode::getDesktopMode().width, sf::VideoMode::getDesktopMode().height)))
    {
