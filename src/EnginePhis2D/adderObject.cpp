...
phis2D::AdderBody::AdderBody(Scena* s, std::vector<std::string>& logs) : scena(s), logs_(logs)
{
}

#pragma region AddDefoltBody

bool phis2D::AdderBody::AddCollider(phis2D::collider::VirtualCollider* collider, float density, float restitution, bool Static)
{
	std::string outMsg;
...
bool phis2D::AdderBody::AddCircle(const v2f& position, float radius, float density, float restitution, bool Static)
{
	std::string outMsg;
...
bool phis2D::AdderBody::AddBox(const v2f& position, const v2f& size, float density, float restitution, bool Static)
{
	std::string outMsg;
...
bool phis2D::AdderBody::AddPolygon(const v2f& position, const v2f* vertices, size_t cntVertices, float density, float restitution, bool Static)
{
	std::string outMsg;
...
#pragma region AddRandomBody

bool phis2D::AdderBody::AddRandomCircle(const v2f& pos, bool Static)
{
...
bool phis2D::AdderBody::AddRandomBox(const v2f& pos, bool Static)
{
...
bool phis2D::AdderBody::AddRandomPolygon(const v2f& pos, bool Static)
{
	size_t n = utility::getRandomNumber(3, 7);
...
bool phis2D::AdderBody::AddRandom(const v2f& pos, bool Static)
{
...
#pragma region CheckProperty

bool phis2D::AdderBody::CheckProperty(float density, std::string& outMsg)
{
...
bool phis2D::AdderBody::CheckProperty(float density, float radius, std::string& outMsg)
{
...
bool phis2D::AdderBody::CheckProperty(float density, float width, float height, std::string& outMsg)
{
	if (!CheckProperty(density, outMsg)) return false;
...
bool phis2D::AdderBody::CheckProperty(float density, const v2f& size, std::string& outMsg)
{
	return CheckProperty(density, size.x, size.y, outMsg);
}

bool phis2D::AdderBody::CheckProperty(const v2f* vertices, size_t cntVertices, std::string& outMsg)
{
	if (vertices == nullptr)
	{
...
bool phis2D::AdderBody::CheckProperty(phis2D::collider::VirtualCollider* collider, std::string& outMsg)
{
	if (collider == nullptr)
	{
		outMsg = "[CheckProperty](--error 'nullptr')\n{ collider is nullptr }";
...
bool phis2D::AdderBody::CheckProperty(phis2D::collider::VirtualCollider* collider, float density, std::string& outMsg)
{
